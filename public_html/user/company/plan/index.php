...
$tempMaincontentUserMenuFile = '../../../common/temp_html/temp_maincontent_user_company_plan.txt';
...
// 担当者メールアドレス
$masterEmail = MASTER_EMAIL_COMPANY;
...
//フォームモード
$formMode = XML_NAME_CMP_PLAN;

//パラメーターを取得する。
$xmlName = XML_NAME_CMP_PLAN;                //XMLファイル名を設定する。
$id = null;
...
$maincontent = null;
$maincontent .= "<h2>";
$maincontent .= "<img src=\"/img/maincontent/pt_user_company_plan.jpg\" title=\"\" alt=\"すべてお任せプランに変更\">";
$maincontent .= "</h2>";
$maincontent .= "\n";
...
_SetBreadcrumbs(PAGE_DIR_COMPANY_PLAN, '', PAGE_TITLE_COMPANY_PLAN, 4);
//パンくずリストを取得する。
